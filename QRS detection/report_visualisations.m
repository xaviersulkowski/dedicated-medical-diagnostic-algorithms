...
xlabel('Czas [s]')
ylabel('Ampplituda [mV]')
legend('Sygna³ EKG', 'Location', 'southoutside')
...
title('Przefiltrowany sygna³ EKG')
xlabel('Czas [s]')
ylabel('Ampplituda [mV]')
legend('Sygna³ EKG', 'Location', 'southoutside')
...
xlabel('Próbki')
ylabel('Ampplituda [mV]')
legend('Zespó³ QRS, po dzia³aniu algorytmu Pan-Tompkinsa', 'Dekopozycja falkowa', 'Punkty przeciêcia z osi¹ Y', 'Location','southoutside')
saveas(fig, './report/SWT.png')
close(fig)
%% SWT on QRS

sig = ECG_filtered(750:1099);
...
xlabel('Próbki')
ylabel('Ampplituda [mV]')
legend('Zespó³ QRS', 'Dekopozycja falkowa', 'Punkty przeciêcia z osi¹ Y', 'Location','southoutside')
...
title('Sygna³ EKG po zastosowaniu metody Pan-Tompkinsa')
xlabel('Czas [s]')
ylabel('Ampplituda [mV]')
legend('Sygna³ EKG po dzia³aniu algorytmu Pan-Tompkinsa', 'R peak', 'Location', 'southoutside')
...
xlabel('Czas [s]')
ylabel('Ampplituda [mV]')
legend('Sygna³ EKG', 'R peak', 'Location', 'southoutside')
...
xlabel('Czas [s]')
ylabel('Ampplituda [mV]')
legend('Sygna³ EKG', 'R peak', 'QRS onset', 'QRS offset', 'Location', 'southoutside')
...
xlabel('Czas [s]')
ylabel('Ampplituda [mV]')
legend('Sygna³ EKG', 'B³êdne wykrycie algorytmu', 'oznaczenia referencyjne')
